...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { address: @info.address, last_name: @info.last_name, name: @info.name, phone: @info.phone } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { address: @info.address, last_name: @info.last_name, name: @info.name, phone: @info.phone } }
